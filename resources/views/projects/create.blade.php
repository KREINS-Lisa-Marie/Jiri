...
<main class="px-6 py-6 flex items-center flex-col">
    ...
    >{{__('headings.create_a_project')}}</h1>

    <form action="{!! route('projects.store') !!}" method="post" class="bg-blue-50 rounded-2xl shadow-2xl p-10 min-w-2xl"
     ...
     {{--       <button type="submit"
                ...
                {{__('labels-buttons.create_a_project')}}
            </button>--}}
