...
<body class=" bg-gray-100 flex justify-center min-h-screen items-center">
<section class=" p-8 max-w-xl bg-white rounded flex-col flex items-center justify-center space-y-5 max-h-fit">
    <div class="flex justify-center mb-4">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-14 w-14 text-indigo-800" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            <path d="M12 3L1 8l11 5 9-4.09V15h2V8L12 3zm0 13l-6-2.727V17c0 2.485 3.582 4.5 6 4.5s6-2.015 6-4.5v-3.727L12 16z"/>
        </svg>
    </div>
    <h1 class="text-2xl font-semibold text-center text-gray-800 mb-6 ">
        {{__('register.create_an_account')}}
    </h1>
    <!-- Icône chapeau -->
    ...
    <form action="{{ route('register.store') }}" method="post" class=" text-black flex flex-col">
        ...
        <div class="flex flex-col">
            ...
            @enderror
            <input type="password" id="confirm_password" name="confirm_password" class="border border-black rounded p-2 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" value="{{old('password')}}">
        </div>
        <div class="py-4 flex flex-row">
            <div>
                <input type="checkbox" name="checkbox" id="checkbox" class="pr-4"></div>
            <label for="checkbox" class="px-2">
                {{__('register.remember_me')}}
            </label>
        </div>
    ...
    <p>
        ...
        <a href="/login" class="text-center text-sm text-blue-600">
            {{__('register.login')}}
        </a>
    </p>
